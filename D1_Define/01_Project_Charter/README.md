...
> وثيقة المشروع هي **وثيقة التفويض الرسمية** لمشروع سيجما ستة. تُحدد المشكلة، وتضع الهدف، وتُحدد النطاق، وتُعيّن الفريق، وتُؤمّن التزام الإدارة — كل ذلك قبل جمع أي بيانات.
